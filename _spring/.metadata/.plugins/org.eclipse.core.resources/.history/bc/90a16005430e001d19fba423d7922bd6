...
<div class="container mt-5">
    ...
    <c:if test="${ses.grade==1 }">
      <a class="nav-link" href="/member/list?pageNo=${pgvo.pageNo}&qty=${pgvo.qty}&type=${pgvo.type}&kw=${pgvo.kw}">List</a>
      </c:if>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="/member/modify?email=${mdto.mvo.email }&pageNo=${pgvo.pageNo}&qty=${pgvo.qty}&type=${pgvo.type}&kw=${pgvo.kw}">Modify</a>
    </li>
    <li class="nav-item">
