...
public class HotelVO {
	...
	public HotelVO(String rno, String guest_name, int guest_age, int guest_gen, String guest_tel) {
	...
	public HotelVO(String rno, String guest_name, String guest_tel, int guest_age, int guest_gen, String is_empty,
