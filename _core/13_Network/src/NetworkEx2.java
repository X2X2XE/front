...
public class NetworkEx2 {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		URL url = new URL("https://news.naver.com/main/list.naver?mode=LS2D&mid=shm&sid1=105&sid2=229");
		...
		System.out.println("5 : " + url.getProtocol());
		System.out.println("=============================");
		System.out.println("4 : " + url.getHost());
