...
//	void bank_info(String owner, String accNum) {
//		System.out.print("계좌번호 : " + accNum);
//		System.out.print(" 예금주 : " + owner);
//		System.out.println(" 계좌잔액 : " + deposit);
//	}
//	
//	void bank_insert(String acc, int money) {
//		if(acc.equals(this.accNum)) {
//			this.deposit += money;
//		}
//	}
//	void bank_out(String acc, int money) {
//		if(acc.equals(this.accNum) && this.deposit > money) {
//			this.deposit -= money;
//		}
//	}
}
