...
public class ProductController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(">>> path : " + path);// 서비스요청경로
		...
		if(path.equals("/product/register.pd")) {
			...
			//service에서 필요한 pvo를 만들어 넘긴다 service를 호출한다
			...
			svc.register(pvo);
			destPage = "/index.jsp";
//			svc.register(new ProductVO(req.getParameter("pname"), Integer.parseInt(req.getParameter("price")), req.getParameter("madeBy")));
			...
			req.setAttribute("pvo", svc.detail(Integer.parseInt(req.getParameter("pno"))));
			...
			destPage = "/index.jsp";
			svc.edit(new ProductVO(Integer.parseInt(req.getParameter("pno")), 
